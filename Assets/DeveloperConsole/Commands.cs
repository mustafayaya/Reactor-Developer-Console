...
namespace Console
{
    public class Commands
    {
        ...
        [ConsoleCommand("heelp", "List all available commands")]
        class Heelp : Command
        {
            public Heelp()
            {
        ...
        [ConsoleCommand("heeelp", "List all available commands")]
        class Heeelp : Command
        {
            public Heeelp()
            {
        ...
        [ConsoleCommand("mooove", "Translate a game object's transform to a world point")]
        class Mooove : Command
        {
            public Mooove()
            {
                commandOptions.Add("transform", new CommandOption<Transform>());
